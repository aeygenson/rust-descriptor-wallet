...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::wallet::descriptor_info,
            ...
            commands::wallet::create_address_book_entry,
            commands::wallet::list_address_book_entries,
            commands::wallet::get_address_book_entry,
            commands::wallet::delete_address_book_entry,
            commands::wallet::lock_utxo,
            commands::wallet::unlock_utxo,
            commands::wallet::list_locked_utxos,
